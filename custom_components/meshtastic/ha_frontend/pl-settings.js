...
const PL_STRINGS = {
  ...
  "Clear the sniffer log?": "Wyczyścić log sniffera?",
  "All captured packets will be removed from the list. The sniffer keeps collecting new ones.": "Wszystkie przechwycone pakiety znikną z listy. Sniffer dalej zbiera nowe.",
  Time: "Czas",
  From: "Od",
  To: "Do",
  "Info": "Informacja",
  ...
  "Select": "Wybierz",
  "Back": "Wstecz",
  "Low level": "Stan niski",
  "High level": "Stan wysoki",
  "Falling edge": "Zbocze opadające",
  "Rising edge": "Zbocze narastające",
  "Either edge (active low)": "Dowolne zbocze (aktywny stan niski)",
  "Either edge (active high)": "Dowolne zbocze (aktywny stan wysoki)",
  "Friendly name": "Przyjazna nazwa",
  "Used in the message sent to the mesh, up to 20 characters": "Używana w wiadomości wysyłanej do sieci, najwyżej 20 znaków",
  "Trigger type": "Rodzaj wyzwalania",
  "Which pin change triggers the alert": "Jaka zmiana stanu pinu wywołuje alarm",
  "Content": "Treść",
  "Decrypted with": "Odczytano dzięki",
  "public default channel {c}": "kluczowi publicznego kanału domyślnego {c}",
  "gateway channel {c}": "kluczowi kanału bramki {c}",
  "gateway channel {c} (unencrypted)": "kanałowi bramki {c} bez szyfrowania",
  "unencrypted channel (no key), name unknown": "kanałowi bez szyfrowania o nieznanej nazwie",
