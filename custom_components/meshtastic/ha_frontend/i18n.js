...
const STRINGS = {
  pl: {
    ...
    "nodes.history.snr": "SNR (bezpośrednio)",
    "nodes.history.rssi": "RSSI (bezpośrednio)",
    "nodes.history.snr_via": "SNR (przez przekaźnik)",
    "nodes.history.rssi_via": "RSSI (przez przekaźnik)",
    "nodes.history.noise_floor": "Poziom szumu",
    "nodes.signal.note": "Zapisujemy SNR i RSSI z każdego pakietu od węzła. Linia „bezpośrednio” pochodzi z pakietów słyszanych wprost i opisuje łącze z tym węzłem, a „przez przekaźnik” z pakietów po skokach i opisuje tylko łącze z przekaźnikiem. Poziom szumu pochodzi z pakietów statystyk lokalnych węzła.",
  ...
  en: {
    ...
    "nodes.history.snr": "SNR (direct)",
    "nodes.history.rssi": "RSSI (direct)",
    "nodes.history.snr_via": "SNR (via relay)",
    "nodes.history.rssi_via": "RSSI (via relay)",
    "nodes.history.noise_floor": "Noise floor",
    "nodes.signal.note": "SNR and RSSI are stored from every packet of the node. The \"direct\" line comes from packets heard straight from the node and describes the link with it; \"via relay\" comes from packets that took hops and describes only the link to the relay. The noise floor comes from the node's local stats packets.",
    "nodes.col.hops": "Hops",
