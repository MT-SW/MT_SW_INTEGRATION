...
const STRINGS = {
  pl: {
    ...
    "nodes.action.ondemand": "Diagnostyka OnDemand",
    "ondemand.title": "Diagnostyka OnDemand",
    ...
    "ondemand.q.ping_ack": "Ping z potwierdzeniem",
    "ondemand.q.nodes_online": "Węzły online",
    "ondemand.q.routing_errors": "Błędy routingu",
    "ondemand.q.port_counters": "Liczniki portów",
    "ondemand.q.air_activity": "Aktywność radiowa",
    "ondemand.q.exchange": "Wymiana pakietów",
    "ondemand.q.rx_avg_time": "Średni czas odbioru",
    "ondemand.q.rx_packet_history": "Historia odbioru",
    "ondemand.q.fw_plus_version": "Wersja FW+",
    ...
    "ondemand.stats.chutil": "Obciążenie kanału",
    "ondemand.stats.airtx": "Czas antenowy TX",
    "ondemand.stats.uptime": "Czas pracy",
    "ondemand.stats.reboots": "Restarty",
    "ondemand.stats.firmware": "Firmware",
    "ondemand.stats.fwplus": "Wersja FW+",
    "ondemand.stats.nodes": "Węzły online / wszystkie",
    "ondemand.stats.blocked_hoplimit": "Zablokowane limitem skoków",
    "ondemand.stats.flood": "Pakiety flood",
    "ondemand.stats.nexthop": "Pakiety next-hop",
    ...
    "ondemand.air.hint": "Czas nadawania, odbioru i błędnego odbioru zgłoszony przez węzeł, w milisekundach, dla kolejnych okien pomiarowych.",
    "ondemand.air.window": "Okno",
    "ondemand.air.tx": "TX",
    "ondemand.air.rx": "RX",
    "ondemand.air.rx_bad": "RX błędne",
    "ondemand.exchange.hint": "Ostatnie pakiety widziane przez węzeł: nadawca → odbiorca, port.",
    "ondemand.rx_avg.hint": "Średni czas odbioru pakietu zgłoszony przez węzeł, w kolejnych oknach pomiarowych.",
    "ondemand.rx_packets.hint": "Liczba pakietów odebranych przez węzeł w kolejnych oknach pomiarowych.",
  ...
  en: {
    ...
    "ondemand.ports.port": "Port",
    "ondemand.air.hint": "TX, RX and bad-RX time reported by the node, in milliseconds, for consecutive measurement windows.",
    "ondemand.air.window": "Window",
    "ondemand.air.tx": "TX",
    "ondemand.air.rx": "RX",
    "ondemand.air.rx_bad": "RX bad",
    "ondemand.exchange.hint": "Latest packets seen by the node: sender → recipient, port.",
    "ondemand.rx_avg.hint": "Average packet receive time reported by the node, for consecutive measurement windows.",
    "ondemand.rx_packets.hint": "Number of packets received by the node in consecutive measurement windows.",
