...
const STRINGS = {
  pl: {
    ...
    "messages.images_on": "Podgląd obrazków z linków: włączony (kliknij, aby wyłączyć)",
    "messages.images_off": "Podgląd obrazków z linków: wyłączony (kliknij, aby włączyć)",
  ...
  en: {
    ...
    "messages.images_on": "Image previews from links: on (click to turn off)",
    "messages.images_off": "Image previews from links: off (click to turn on)",
