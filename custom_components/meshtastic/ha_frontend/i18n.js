...
const STRINGS = {
  pl: {
    ...
    "nodes.signal.note": "Zapisujemy tylko pakiety słyszane bezpośrednio, bez przekaźników — tylko one opisują łącze z tym węzłem. Poziom szumu pochodzi z pakietów statystyk lokalnych węzła.",
  ...
  en: {
    ...
    "nodes.signal.note": "Only packets heard directly, without relays, are stored — only those describe the link with this node. The noise floor comes from the node's local stats packets.",
    "nodes.col.hops": "Hops",
